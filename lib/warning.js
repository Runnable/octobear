...
module.exports = class Warnings {
  ...
  *[Symbol.iterator] () {
  ...
  static buildAndImage (service, warnings) {
    const serviceCopy = Object.assign({}, service)
    if ((serviceCopy.build && !serviceCopy.build.disabled) && serviceCopy.image) {
      warnings.add('The `image` has been ignored since a `build` was provided', { image: serviceCopy.image })
